			...
			for ($i=0; $i < count($sql); $i++) {
				...
				if($sql[$i]['fle_acompanante'] != ''){
					...
					for ($d=0; $d < count($explorar_acompanante); $d++) {
						...
						$acompanantes .= '<div class="row">
										<div class="col"><b>Acompañante '.$cont_acompanantes++.': </b>'.ucfirst(mb_strtolower(Utilidades::matar_espacio($acompa[0]['tra_nombre']))).'</div>
									</div>';
					}
				...
				$html  .= '<tr>
								...
								<td>
									<small>
										<div class="row">
											<div class="col"><b>Conductor: </b>'.ucfirst(mb_strtolower(Utilidades::matar_espacio($trabajador[0]['tra_nombre']))).'</div>
										</div>
										'.$acompanantes.'
									</small>
								</td>
										...
										<div class="row">
											<div class="col-6">
												<div class="row">
													...
													<div class="col-6 text-primary">'.ucfirst($nombre_origen).'</div>
													<div class="col-6"><b>&nbsp;Destino:</b> </div>
													<div class="col-6 text-primary">'.ucfirst($nombre_destino).'</div>
												</div>
												<div class="row">
