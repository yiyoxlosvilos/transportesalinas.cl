(function(h) {
    ...
    function ob(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" placeholder="Buscar" class="' + b.sFilterInput + ' form-control shadow"/>',
            j = d.sSearch,
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "Sin informacion",
            sInfo: " _START_ a _END_ de _TOTAL_ vistas",
            sInfoEmpty: " 0 a 0 de 0 vistas",
            sInfoFiltered: "(filtro de _MAX_ total vistas)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: " _MENU_ ",
    ...
    h.extend(m.ext.classes, {
        ...
        sFilterInput: "",
        sLengthSelect: " form-control shadow",
    ...
    h.extend(Kb, {
        ...
        simple_numbers: function(a, b) {
            return ["Last", ha(a, b), "Next"]
        },
        full_numbers: function(a, b) {
            return ["First", "Last", ha(a, b), "Next", "Prev"]
        },
