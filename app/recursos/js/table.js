...
(function(l) {
    ...
    function la(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "Sin Informacion disponible" === b.sEmptyTable && Y(a, a, "sZeroRecords", "sEmptyTable");
            !a.sLoadingRecords && d && "Cargando..." === b.sLoadingRecords &&
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "Sin Informacion Diponible",
            sInfo: " _START_ a _END_ de _TOTAL_ Datos",
            sInfoEmpty: " 0 a 0 de 0 Datos",
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Informacion no encontrada"
        },
