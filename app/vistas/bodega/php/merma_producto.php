...
<div class="row d-flex justify-content-center mt-100">
    <p align="left" class="text-danger font-weight-light h3">Mermas Productos</p>
    <div class="col-md-7">
        <?= $bodega->select_productos_multiple(1); ?> 
    </div>
    <div class="col-md-3">
        <span class="btn btn-primary w-lg waves-effect waves-light w-100 waves-effect waves-light " type="button" onclick="asignar_productos_merma()">
