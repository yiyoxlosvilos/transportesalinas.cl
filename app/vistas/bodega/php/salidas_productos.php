...
<div class="row d-flex justify-content-center mt-100">
    <p align="left" class="text-primary font-weight-light h3"><i class="fas fa-arrow-alt-circle-down"></i> Salida Productos</p>
    <div class="col-md-7">
        <?= $bodega->select_productos_multiple(1); ?> 
    </div>
    <div class="col-md-3">
        <span class="btn btn-primary w-lg waves-effect waves-light w-100 waves-effect waves-light " type="button" onclick="salidas_productos_lista()">
