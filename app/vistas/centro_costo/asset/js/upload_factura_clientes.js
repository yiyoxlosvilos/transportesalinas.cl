...
(function (factory) {
    ...
    $h = {
        ...
        getZoomPlaceholder: function () { // used to prevent 404 errors in URL parsing
            ...
            return srcPath.substring(0, srcPath.lastIndexOf("/") + 1) + 'img/loader.svg' + zoomVar;
        },
        isBs: function (ver) {
        ...
        defaultButtonCss: function (fill) {
            return 'btn-dark btn-' + (fill ? '' : 'outline-') + 'secondary';
        },
        now: function () {
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            prev: 'btn btn-info btn-outline-info btn-navigate',
            next: 'btn btn-info btn-outline-info btn-navigate',
        ...
        browseIcon: '<i class="bi bi-file-earmark-image"></i> ',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="bi-trash text-white"></i>',
        ...
        uploadIcon: '<i class="bi-upload text-white" onClick="subir_documento_factura_cliente()"></i>',
