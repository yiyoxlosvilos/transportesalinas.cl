    ...
    <div class="container mb-4">
      <div class="row">
        ...
        <div class="col-15" id="nueva_categoria">
          <?= $recursos->listado_categorias_gastos() ?>
        </div>
      </div>
    </div>
  </div>
  <div class="col-lg-6 mb-2 shadow">
    <div class="container mb-4">
      <div class="row">
        <div class="col">
          <div class="col-lg-3 mb-2">
            <p align="center" class="text-secondary font-weight-light h4">Tipo</p>
          </div>
        </div>
        <div class="col">
          <div class="col-lg-3 mb-2">
            <span class="btn btn-success w-lg waves-effect waves-light w-100 waves-effect waves-light " type="button" onclick="nuevo_tipo_categoria()">
              <i class="bi bi-plus-circle-dotted"></i>
            </span>
          </div>
        </div>
        <div class="col-15" id="nueva_marca">
          <?= $recursos->listado_tipo_categorias_gastos() ?>
        </div>
      </div>
    </div>
  </div>
