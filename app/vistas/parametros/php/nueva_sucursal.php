...
<div class="row mb-4">
  <p align="left" class="text-success font-weight-light h3">Nueva Sucursal</p>
  <hr class="mt-2 mb-3"/>
    <div class="container mb-4">
      <div class="row">
        ...
        <div class="col-lg-5 mb-2">
          ...
          <button type="button" id="grabar" class="btn btn-primary form-control shadow" onclick="grabar_sucursal()">Grabar <i class="bi bi-save"></i></button>
        </div>
      </div>
    </div>
</div>