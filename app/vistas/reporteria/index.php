...
<body id="body-pd">
  <div class="row paddingtop40px mt-5 mb-4">
    <div class="card-block text-center">
      ...
      <button class="btn btn-info bg-gradient" onclick="informe_ventas()">Informe&nbsp;&nbsp;<i class="bi bi-file-bar-graph"></i></button>
      <button class="btn btn-warning bg-gradient" onclick="reporte_financiero()">Reporte&nbsp;&nbsp;<i class="bi bi-bank"></i></button>
      <button class="btn btn-primary bg-gradient" onclick="estado_pago()">Estados de Pago&nbsp;&nbsp;<i class="fas fa-hand-holding-usd"></i></button>
    </div>
    <hr class="mt-2 mb-3"/>
