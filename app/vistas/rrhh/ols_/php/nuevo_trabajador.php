    ...
    <div class="container mb-4">
      <div class="row">
        ...
        <div class="col-lg-5 mb-2">
          ...
          <input type="text" class="form-control shadow" id="inputCargo" placeholder="Escribir Cargo" value="CHOFER" autocomplete="off">
        </div>
        <div class="col-lg-5 mb-2">
          <label for="inputTipo">&nbsp;</label>
          <button type="button" id="grabar" class="btn btn-primary form-control shadow bg-gradient" onclick="grabar_trabajador()">Grabar <i class="bi bi-save"></i></button>
        </div>
      </div>
    </div>
</div>