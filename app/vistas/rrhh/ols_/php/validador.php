<?php 
	...
	switch ($accion) {
		...
		case 'grabar_trabajador':
			...
			$grabar = $rrhh->grabar_trabajador($inputNombre, $inputRut, $inputCargo);
		...
		case 'editar_trabajador':
			...
			$grabar = $rrhh->editar_trabajador($inputNombre, $inputRut, $inputCargo, $idTrabajador);
		...
		case 'subir_documento_trabajador':
			...
			if ($_FILES){
				...
				if(move_uploaded_file($_FILES['file']['tmp_name'], $destino)){
					$grabar         = $rrhh->grabar_insertar_documento($nombre, $inputTitulo, $idTrabajador);
