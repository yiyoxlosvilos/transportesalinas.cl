...
<div class="row d-flex justify-content-center mt-100">
  <div class="col">
    <h4 align="left" class="text-danger font-weight-light h3"><i class="bi bi-joystick"></i> SIMULADOR</h4>
  </div>
  <div class="col">
    <table width="100%" align="center" cellpadding="6" cellspacing="6" class="table table-striped">
      <tbody>
        <tr>
  ...
  <div class="col">
    <table width="100%" align="center" cellpadding="5" cellspacing="5" class="table table-striped">
      <tbody>
        <tr>
  ...
  <div class="col">
    <table width="100%" cellpadding="5" cellspacing="5" class="table-striped shadow">
      <tr class="text-info h4">
        ...
        <tr class="blanco">
          <td align="left"><b>Sueldo Base</b></td>
          <td align="left">D&iacute;as Trabajados</td>
        </tr>
        <tr class="blanco">
          <td align="left">
            <input type="number" class="form-control" name="sueldo_base" id="sueldo_base" placeholder="N&deg; sin puntos." onchange="simular_sueldo()">
          </td>
          <td align="left">
    ...
    <div class="col">
      <table  width="100%" cellpadding="6" cellspacing="6" class="table-striped shadow">
                ...
                <tr class="blanco" >
                  <td align="left">&nbsp;</td>
                  <td align="left" style="display: none;" id="impuesto_unico_add">
                    Impuesto Unico.
