...
function gastos_empresa() {
    ...
    $('#traer_gastos').load(url_link+"app/vistas/finanzas/php/nuevo_gasto.php", {accion:accion, idServicio:idServicio});
}
...
// abonos arriendos
function traer_nuevo_abono_arriendo(idFlete) {
    const url_link = document.getElementById('url_link').value;
    var accion     = "traer_nuevo_abono_arriendo";
...
function grabar_abono_arriendo(idFlete) {
    const url_link = document.getElementById('url_link').value;
    var accion     = "grabar_abono_arriendo";
            ...
            $.ajax({
              ...
              success:     function(sec) {
                Swal.fire({
                  ...
                  traer_panel_pagos_arriendo(idFlete);
                })  
              },
              error:       function(sec) {
                Swal.fire("Error", "Error", "error");
...
function quitar_abono_arriendo(idAbono, idFlete) {
    const url_link = document.getElementById('url_link').value;
    var accion     = "quitar_abono";
...
function traer_panel_pagos_arriendo(idFlete) {
    const url_link = document.getElementById('url_link').value;
    var accion     = "traer_panel_pagos_arriendo";
...
function traer_procesar_pago_arriendo(idFlete) {
    const url_link = document.getElementById('url_link').value;
    var accion     = "traer_procesar_pago_arriendo";
...
function grabar_pago_arriendo(idFlete) {
    const url_link = document.getElementById('url_link').value;
    var accion     = "grabar_pago_arriendo";
              ...
              success:     function(sec) {
                Swal.fire({
                  ...
                  cancelButtonText:   'NO',
                    ...
                    $("#traer_nuevo_abono").hide();
                    $("#traer_procesar_pago").hide();
                  traer_finalizar_pagos_arriendo(idFlete);
                })  
              },
              error:       function(sec) {
                Swal.fire("Error", "Error", "error");
...
function traer_finalizar_pagos_arriendo(idFlete) {
    const url_link = document.getElementById('url_link').value;
    var accion     = "traer_finalizar_pagos_arriendo";
...
function buscar_viajes() {
    const url_link = document.getElementById('url_link').value;
    var mes         = document.getElementById('mes_viajes').value;
