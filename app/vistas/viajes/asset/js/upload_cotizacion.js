...
(function (factory) {
    ...
    $h = {
        ...
        defaultButtonCss: function (fill) {
            return 'btn-secondary btn-' + (fill ? '' : 'outline-') + 'secondary';
        },
        now: function () {
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            prev: 'btn btn-secondary btn-outline-secondary btn-navigate',
            next: 'btn btn-secondary btn-outline-secondary btn-navigate',
        ...
        uploadIcon: '<i class="bi-upload" onClick="subir_documento_cotizacion()"></i>',
